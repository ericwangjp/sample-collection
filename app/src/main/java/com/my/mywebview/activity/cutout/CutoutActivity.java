...
import com.my.mywebview.activity.cutout.picturecut.ProcessActivity;
...
public class CutoutActivity extends CommonBaseActivity {
    ...
    protected void initTitleBar() {
        ...
        title.setTextCenter(R.string.title_pic_editor);
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id)
            {
                if( imageItem.size() == 10) { //第一张为默认图片
                    Toast.makeText(CutoutActivity.this, "图片最多为9张", Toast.LENGTH_SHORT).show();
                }
    ...
    protected void onListener() {
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //判断是否添加图片
                if(imageItem.size()==1) {
                    Toast.makeText(CutoutActivity.this, "没有图片需要上传", Toast.LENGTH_SHORT).show();
                    return;
                }
                //消息提示
                Toast.makeText(CutoutActivity.this, "上传成功", Toast.LENGTH_SHORT).show();
            }
        });
 ...
 */
    protected void AddImageDialog() {
        ...
        builder.setItems(new String[] {"本地相册选择","相机拍照","取消"},
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch(which) {
                            ...
                            case 1: //手机相机
                                dialog.dismiss();
                                File outputImage = new File(Environment.getExternalStorageDirectory(), "temp_image.jpg");
