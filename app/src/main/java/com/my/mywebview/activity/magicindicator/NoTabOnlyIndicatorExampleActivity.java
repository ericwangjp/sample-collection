package com.my.mywebview.activity.magicindicator;
    ...
    private void initMagicIndicator1() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                float lineHeight = context.getResources().getDimension(R.dimen.dimens50dp);
    ...
    private void initMagicIndicator2() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                float smallNavigatorHeight = context.getResources().getDimension(R.dimen.dimens20dp);
