...
import com.my.mywebview.adapter.ExamplePagerAdapter;
...
public class MagicClipIndicatorActivity extends CommonBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_magic_clip_indicator);
    ...
    private void initMagicIndicator3() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerIndicator getIndicator(Context context) {
                LinePagerIndicator indicator = new LinePagerIndicator(context);
                float navigatorHeight = context.getResources().getDimension(R.dimen.dimens50dp);
    ...
    private void initMagicIndicator4() {
        ...
        titleContainer.setDividerDrawable(new ColorDrawable() {
            ...
            public int getIntrinsicWidth() {
                return UIUtil.dip2px(MagicClipIndicatorActivity.this, 15);
            }
        });
