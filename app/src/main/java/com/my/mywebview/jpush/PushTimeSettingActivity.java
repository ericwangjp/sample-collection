...
public class PushTimeSettingActivity extends InstrumentedActivity implements OnClickListener {
	...
	private void initTitleBar() {
		...
		title.setTextCenter(R.string.title_set_push_time);
	...
	private void setPushTime(){
		...
		if (startime > endtime) {
			Toast.makeText(PushTimeSettingActivity.this, "开始时间不能大于结束时间", Toast.LENGTH_SHORT).show();
			return;
		}
		...
		mEditor.commit();
		Toast.makeText(PushTimeSettingActivity.this, R.string.setting_su, Toast.LENGTH_SHORT).show();
	}
