 ...
 * @author WJP
 * @version Vx.x.x
 * @date 2017/8/30 19:56
 * @email wang_jp@murongtech.com
 */
public class WeiXinUploadPicCallBack extends ItemTouchHelper.Callback {

    private int dragFlags;
    private int swipeFlags;
    private WeChatUploadAdapter adapter;
    ...
    public WeiXinUploadPicCallBack(WeChatUploadAdapter adapter, List<String> images, List<String> originImages,Context context) {
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        if (dY >= (recyclerView.getHeight()
                ...
                - DensityUtil.dip2px(context.getApplicationContext(),50))) {//拖到删除处
