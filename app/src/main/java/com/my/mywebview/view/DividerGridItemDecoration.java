...
//          该判断可去除最后一行下边的divider，需要可删除该判断
    ...
    private void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++){
 //          该判断可去除最后一列右边的divider，需要可删除该判断
//            在瀑布流时滑动屏幕右边divider会有闪烁，暂且不用
...
//            }
    ...
    public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
        ...
        {
//            outRect.set(0, 0, isLastColum(parent,itemPosition,spanCount,childCount) ? 0 : mDivider.getIntrinsicWidth(),
