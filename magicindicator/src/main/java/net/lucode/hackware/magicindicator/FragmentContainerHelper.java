...
public class FragmentContainerHelper {
    ...
    //此处不加static赋值要给-1否则首个不可点；加上static当点击同一个时不会再有动画效果，
    // 去掉static赋值为-1再次点击同一个依旧有动画效果
    ...
    public void handlePageSelected(int selectedIndex, boolean smooth) {
        Log.i("mLastSelectedIndex的值",mLastSelectedIndex+"");
        ...
        Log.i("最后赋值的selectedIndex",selectedIndex+"");
    }
